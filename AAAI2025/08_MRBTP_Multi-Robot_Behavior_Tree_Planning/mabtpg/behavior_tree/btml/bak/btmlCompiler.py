...
if "." in __name__:
    from mabtpg.behavior_tree.btml.bak.btmlTranslator import btmlTranslator
    from mabtpg.behavior_tree.btml.bak.btmlParser import btmlParser as Parser
...
# format_trans_to_bracket('C:\\Users\\Estrella\\Desktop\\mabtpg.behavior_tree\\mabtpg.behavior_tree\\behavior_tree\\btml\\llm_test\\robot.bt')
