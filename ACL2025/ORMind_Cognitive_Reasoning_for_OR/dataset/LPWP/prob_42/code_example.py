...
def prob_42(old, new_farm, constraint1, constraint2, constraint3, constraint4, constraint5, constraint6):
    ...
    Args:
        old: A float, the cost to operate at the old farm per day.
        new_farm: A float, the cost to operate at the new farm per day.
    ...
    Returns:
        obj: A float, the objective value (minimum cost) to meet the contract.
    """
    obj = 1e9
    # To be implemented
