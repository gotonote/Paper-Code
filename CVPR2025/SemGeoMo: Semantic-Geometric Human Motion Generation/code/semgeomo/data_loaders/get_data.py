...
from .tensors import collate as all_collate, babel_collate, babel_eval_collate, pw3d_collate
from .tensors import t2m_collate
from .humanml.data.dataset import collate_fn as sorted_collate
from .humanml.data.dataset import BEHAVE,IMHOI,OMOMO,Hodome,INTERX,INTERGEN
...
def get_collate_fn(name, load_mode='train'):
    ...
    if name in ["humanml", "kit","behave","imhoi","omomo","interx","intergen","Unify","Hodome"]:
        return t2m_collate
    elif name == 'pw3d':
        return pw3d_collate
    elif name == 'babel':
...
def get_dataset(name, num_frames, split='train', load_mode='train', batch_size=None, opt=None, short_db=False, cropping_sampler=False, size=None):
    ...
    if name in ["humanml", 'kit', "pw3d","behave","imhoi","omomo","interx","intergen","Unify","Hodome"]:
