...
class DiT(nn.Module):
    ...
    def forward(self, x, t, y):
        ...
        for i, block in enumerate(self.blocks):
            ...
            if (
                self.reuse_feature[i] is not None
                and 2 * i + 1 not in self.rank[router_idx]
            ):
            ...
            if self.reuse_feature[i] is None:
                ...
                if 2 * i in self.rank[router_idx]:
                    self.reuse_feature[i][0] = reuse_feature[0]
                if 2 * i + 1 in self.rank[router_idx]:
                    self.reuse_feature[i][1] = reuse_feature[1]
            # self.reuse_feature[i] = reuse_feature
