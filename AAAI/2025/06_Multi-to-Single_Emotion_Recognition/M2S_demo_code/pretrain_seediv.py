...
from data import SEEDIV_multi_modal_time, SEEDIV_LabelFeature
...
if __name__ == '__main__':
    ...
    for session in [1, 2, 3]:
        ...
        for file in file_list:
            ...
            label_feature = SEEDIV_LabelFeature(train_dataset.eeg, train_dataset.eye, train_dataset.label, time_window=5)
            max_eeg2eye_acc = 0
            max_eeg2eeg_acc = 0
            max_eye2eeg_acc = 0
            max_eye2eye_acc = 0
